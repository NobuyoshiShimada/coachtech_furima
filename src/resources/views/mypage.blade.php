                ...
                <div class="user-profile__info">
                    ...
                    <div class="user-profile__avatar">
                        @if ($user->profile && $user->profile->image_url)
                            <img src="{{ asset('storage/' . $user->profile->image_url) }}" alt="avatar"
        ...
        <div class="tab-nav">
            <div class="tab-nav__inner">
                <a href="/mypage?tab=sell"
                    class="tab-nav__link {{ request('tab') !== 'buy' ? 'tab-nav__link--active' : '' }}">出品した商品</a>
                <a href="/mypage?tab=buy"
                    class="tab-nav__link {{ request('tab') === 'buy' ? 'tab-nav__link--active' : '' }}">購入した商品</a>
            </div>
        </div>
